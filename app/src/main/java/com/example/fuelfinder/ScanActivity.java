...
public class ScanActivity extends AppCompatActivity {
    ...
    public void continueButtonPress(View v) {
        ...
        Log.d("scan:", "transferringCost:" + total_cost);
        manualIntent.putExtra("CapacityScan", fuel_refill);
        Log.d("scan:", "transferringCapacity:" + fuel_refill);
        Log.d("scan:", "transferringOdo:" + odometer);
        manualIntent.putExtra("OdometerScan", (double)odometer);
        manualIntent.putExtra("EconomyScan", fuel_eco);
        Log.d("scan:", "transferringEco:" + fuel_eco);
